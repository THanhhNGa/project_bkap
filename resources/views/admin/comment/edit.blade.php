...
@section('main')
<form action="{{route('edit_blog',['id'=>$qr->id])}}" method="POST"  role="form">
	@csrf
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h3 class="panel-title">Chỉnh sửa tin tức</h3>
		</div>
	</div>
	<div class="col-md-8">
		<div class="form-group">
			<label class="" for="">Tiêu đề bài viết</label>
	...
	<div class="col-md-4">
		...
		<div class="form-group">
			...
			<img src="{{url('')}}/uploads/{{$qr->image}}" alt="" id="show_img" width="150px">
		</div>
	</div>
